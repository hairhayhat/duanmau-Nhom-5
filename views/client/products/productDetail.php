...
<body class="theme-color2 light ltr">
                                        ...
                                        <ul class="category-list">
                                            <li>
                                                <div class="service-wrap">
                                                    <div class="service-icon">
                                                        <svg>
                                                            <use xlink:href="client/assets/svg/icons.svg#customer"></use>
                                                        </svg>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="service-wrap">
                                                    <div class="service-icon">
                                                        <svg>
                                                            <use xlink:href="client/assets/svg/icons.svg#shop"></use>
                                                        </svg>
                                                    </div>
                                                    <div class="service-content">
                                            ...
                                            <li>
                                                <div class="service-wrap">
                                                    <div class="service-icon">
                                                        <svg>
                                                            <use xlink:href="client/assets/svg/icons.svg#secure-payment">
                                                            </use>
                                                        </svg>
                                                    </div>
                                                    <div class="service-content">
                                            ...
                                            <li>
                                                <div class="service-wrap">
                                                    <div class="service-icon">
                                                        <svg>
                                                            <use xlink:href="client/assets/svg/icons.svg#return"></use>
                                                        </svg>
                                                    </div>
                                                    <div class="service-content">
                                                        <h3>Free Returns</h3>
                            ...
                            <div class="col-lg-5 col-md-6">
                                <div class="degree-section">
                                    <div class="details-image ratio_asos">
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="client/assets/images/fashion/1.jpg" id="zoom_01"
                                                    data-zoom-image="client/assets/images/fashion/1.jpg"
                                        ...
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="client/assets/images/fashion/2.jpg" id="zoom_02"
                                                    data-zoom-image="client/assets/images/fashion/2.jpg"
                                        ...
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="client/assets/images/fashion/3.jpg" id="zoom_03"
                                                    data-zoom-image="client/assets/images/fashion/3.jpg"
                                        ...
                                        <div>
                                            <div class="product-image-tag">
                                                <img src="client/assets/images/fashion/4.jpg" id="zoom_04"
                                                    data-zoom-image="client/assets/images/fashion/4.jpg"
                                    ...
                                    <div class="details-image-option black-slide mt-4 rounded">
                                        <div>
                                            <img src="client/assets/images/fashion/1.jpg" class="img-fluid blur-up lazyload"
                                                alt="">
                                        </div>
                                        <div>
                                            <img src="client/assets/images/fashion/2.jpg" class="img-fluid blur-up lazyload"
                                                alt="">
                                        </div>
                                        <div>
                                            <img src="client/assets/images/fashion/3.jpg" class="img-fluid blur-up lazyload"
                                                alt="">
                                        </div>
                                        <div>
                                            <img src="client/assets/images/fashion/4.jpg" class="img-fluid blur-up lazyload"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="cloth-details-size">
                                    <div class="product-count">
                                        <ul>
                                            <li>
                                                <img src="client/assets/images/gif/fire.gif" class="img-fluid blur-up lazyload"
                                                    alt="image">
                            ...
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-lg-4">
                                            <img src="client/assets/images/fashion/slider/1.jpg"
                                        ...
                                        <div class="col-lg-4 order-lg-0 mt-4">
                                            <img src="client/assets/images/fashion/slider/2.jpg"
                                                class="img-fluid rounded blur-up lazyload" alt="">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="customer-review-box">
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="client/assets/images/inner-page/review-image/1.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="client/assets/images/inner-page/review-image/2.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="client/assets/images/inner-page/review-image/3.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            ...
                                            <div class="customer-section">
                                                <div class="customer-profile">
                                                    <img src="client/assets/images/inner-page/review-image/4.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
        ...
        <div class="container">
            <div class="cart-content">
                <div class="product-image">
                    <img src="client/assets/images/fashion/instagram/1.jpg" class="img-fluid blur-up lazyload" alt="">
                    <div class="content">
    ...
    <div class="recently-purchase d-md-flex d-none">
        <img src="client/assets/images/fashion/instagram/3.jpg" class="img-fluid blur-up lazyload" alt="">
                        ...
                        <div>
                            ...
                            <div class="modal-product">
                                <div class="modal-contain-img">
                                    <img src="client/assets/images/fashion/instagram/4.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
    ...
    <div class="modal modal-size fade" id="sizemodal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="client/assets/images/size-chart.jpg" alt="" class="img-fluid blur-up lazyload">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="added-notification">
        <img src="client/assets/images/fashion/banner/2.jpg" class="img-fluid blur-up lazyload" alt="">
        <h3>added to cart</h3>
    </div>
    <!-- Add To Cart Notification -->
    ...
    <!-- latest jquery-->
    <script src="client/assets/js/jquery-3.5.1.min.js"></script>

    <!-- Add To Home js -->
    <script src="client/assets/js/pwa.js"></script>
    ...
    <!-- timer js -->
    <script src="client/assets/js/timer.js"></script>

    <!-- sticky cart bottom js-->
    <script src="client/assets/js/sticky-cart-bottom.js"></script>

    <!-- sticky cart bottom js-->
    <script src="client/assets/js/check-box-select.js"></script>
    ...
    <script src="client/assets/js/cart_modal_resize.js"></script>

    <!-- Notify js-->
    <script src="client/assets/js/bootstrap/bootstrap-notify.min.js"></script>

    <!-- script js -->
    <script src="client/assets/js/theme-setting.js"></script>
