                                        ...
                                        <div class="main-navbar">
                                            <div id="mainnav">
                                                ...
                                                <ul class="nav-menu">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="javascript:void(0)"
                                                            class="nav-link menu-title">Categories</a>
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="javascript:void(0)"
                                                            class="nav-link menu-title">product</a>
                                                        <ul class="nav-submenu menu-content">
                                                            <li>
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="javascript:void(0)"
                                                            class="nav-link menu-title">pages</a>
                                                        <ul class="nav-submenu menu-content">
                                                            <li>
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="javascript:void(0)"
                                                            class="nav-link menu-title">blog</a>
                                                        <ul class="nav-submenu menu-content">
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="blog-masonary.html">blog Masonary
                                                                    <span>New</span></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li class="mobile-poster d-flex d-xl-none">
                                                        <img src="client/assets/images/pwa.png" class="img-fluid"
                                                            alt="">
                                                ...
                                                <div class="onhover-div profile-dropdown">
                                                    <ul>
                                                        <?php if (isset($_SESSION['user'])): ?>
                                                            ...
                                                            <li>
                                                                <a href="index.php?act=update-profile&user_id=<?=$user['user_id']?>"
                                                                    class="d-block">Update profile</a>
                                                            </li>
                                                            <li>
